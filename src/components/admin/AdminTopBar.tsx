  ...
  return (
    <header className="adm-topbar h-16 bg-[#070C18]/80 backdrop-blur-sm border-b border-white/5 flex items-center px-4 lg:px-6 shrink-0 gap-3 lg:gap-4">
      ...
      <button
        ...
        className="w-9 h-9 bg-white/4 border border-white/6 rounded-xl flex items-center justify-center hover:bg-white/8 transition-all"
        style={{ color: theme === "light" ? "#F59E0B" : "#93C5FD" }}
      >
